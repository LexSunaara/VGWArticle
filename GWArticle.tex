...
\begin{align}																			 		\\
	\phi_{0,\mathrm{w}}      &  = 	-\text{sign}\left(\left(c-\overline{u}\right)k\right)\left(im_{0}+\frac{k^{4}+3m_{0}^{4}}{2\left(c-\overline{u}\right)km_{0}\mathrm{Re}}\right)	\\
	\phi_{0,\mathrm{bl}}     &  =	\left(1-i\right)\frac{m_{0}^{2}-k^{2}}{\sqrt{\left|c-\overline{u}\right|\left|k\right|\mathrm{Re}}}
\end{align}
...
In the limit of $\mathrm{Re}\gg1$, we have 
\begin{align}																			 		\\
	\phi_{0,\mathrm{w}}      &  = 	-icm_{0}-\left(1-i\right)m_{0}^{2}\sqrt{\frac{\left|c\right|}{2\left|k\right|\mathrm{Re}}}+\frac{k^{4}+2m_{0}^{2}k^{2}+3 m_{0}^{2}}{2km_{0}\mathrm{Re}} 	\\
	\phi_{0,\mathrm{bl}}     &  =	icm_{0}+\left(1-i\right)m_{0}^{2}\sqrt{\frac{\left|c\right|}{2\left|k\right|\mathrm{Re}}}-\frac{k^{4}+2m_{0}^{2}k^{2}+3 m_{0}^{2}}{2km_{0}\mathrm{Re}} 
\end{align}
