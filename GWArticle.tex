...
Internal gravity waves play a major role in geophysical fluid dynamics. The underlying reason of their increasing importance comes from their primary contribution to the mixing in the ocean (see \cite{Wunsch2005}) and in the redistribution of energy and momentum in the atmosphere (see \cite{Fritts1984}). 
...
\begin{equation}
	L_{\mathrm{Re}}=\frac{2 \left|k\right| \left|c-\overline{u}\right|^5 \mathrm{Fr}^4\mathrm{Re}m_{0}}{n^{2}}.
\end{equation}
...
\begin{equation}
	\partial_{Z}\left(\frac{\phi_{0,\mathrm{Prop}}^{2}\left(c-\overline{u}\right)^{2}}{m_{0}}\right)=0
\end{equation}
